...
export const GlobalSpotlight: React.FC<{
    ...
    `;
            ...
            const handleMouseMove = (e: MouseEvent) => {
                ...
                const cards = gridRef.current.querySelectorAll('.card--border-glow');
...
export const BentoSection: React.FC<{
    ...
    enableSpotlight?: boolean;
    spotlightRadius?: number;
}> = ({ children, className = '', glowColor = DEFAULT_GLOW_COLOR, enableSpotlight = true, spotlightRadius = DEFAULT_SPOTLIGHT_RADIUS }) => {
